...
export const ASSET_DESCRIPTIONS: Record<string, string> = {
    "Dune_Buggy": "A fast, lightweight vehicle ideal for crossing open terrain quickly, though it offers little protection.",
    "Ghillie_Mantle": "A camouflage cloak made of synthetic fibers and local flora, offering superb concealment in forests.",
    "Advanced_Sonar": "A recovered piece of old-world tech that can detect dense scrap deposits deep underground.",
    "Hydro_Purifier": "A portable device that makes questionable water sources safe, drastically improving the success of finding food.",
    "Bunker_Buster": "A heavy-duty explosive charge designed to breach fortified positions in urban environments.",
    "Junk_Forged_Armor": "Layers of scrap metal and hardened leather, providing a baseline improvement to troop survivability.",
    "Whetstone": "A simple but effective tool for keeping blades sharp, ensuring every strike counts.",
    "Seed_Vault": "A collection of pre-war seeds, genetically engineered for resilience. Provides a small, steady supply of food.",
    "Scrap_Compressor": "An automated hydraulic press that compacts loose junk into usable scrap plates.",
    "Mountaineering_Gear": "Picks, ropes, and climbing harnesses that allow for aggressive maneuvers in treacherous mountain terrain.",
    "Swamp_Skiff": "A flat-bottomed boat perfect for navigating murky bogs, allowing for better defensive positioning.",
    "Desert_Cloaks": "Flowing robes that provide protection from the sun and sand, helping troops blend into the desert landscape.",
    "Barbed_Wire": "Spools of rusted, sharp wire, perfect for creating defensive perimeters in open plains.",
    "Ambush_Netting": "Lightweight nets that can be quickly deployed from treetops, entangling enemies in forest ambushes.",
    "Scrap_Cannon": "A crude but effective projectile launcher, deadly when used in the open badlands.",
    "Radiation_Suit": "A lead-lined suit that offers some protection against hazardous environments.",
    "Scouts_Medkit": "A pouch containing bandages, herbal remedies, and stimulants, increasing the amount of foraged food.",
    "Masterwork_Tools": "A set of high-quality pre-war tools, invaluable for salvaging and repairing complex weapon systems.",
    "Ballistic_Shields": "Heavy shields made from repurposed vehicle armor, excellent for defending fortified positions in ruins.",
    "Ratchet_Set": "A complete set of wrenches and ratchets, making the disassembly of junk for scrap far more efficient."
};